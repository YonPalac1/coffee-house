    ...
    return <div className="bg-gray-900">
        ...
        <section className="text-center mt-24 p-5 md:pl-12 md:pr-12 lg:pl-56 lg:pr-56">
            <motion.span 
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }} 
                className="text-orange-400 capitalize">Nuestro menu</motion.span>
            <motion.h4 
                initial={{ opacity: 0, y: 100 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }} 
                className="capitalize text-3xl md:text-5xl mt-3 text-white">Elige tu café perfecto</motion.h4>
        ...
        <section className="comments text-center text-white pt-24 pb-24 mt-24 pl-5 pr-5 md:pl-12 md:pr-12 lg:pr-56 lg:pl-56">
            ...
            <motion.p
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }} 
                className="tangerine text-3xl">Entré buscando un café para despertarme pero encontré mucho màs. El aroma del café me envolvio al instante y la decoración me hizo sentir como en casa.</motion.p>
            <motion.h4 
                initial={{ opacity: 0, y: 100 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }} 
                className="text-2xl mt-5">Lucia</motion.h4>
            <motion.span  
                initial={{ opacity: 0, y: 100 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }} 
                className="text-orange-400 text-5xl tangerine">clientes del restaurante</motion.span>
        </section>
