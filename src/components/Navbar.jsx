...
export default function Navbar() {
    ...
    return <nav className="navbar bg-black text-white sticky top-[-60px] z-10">
        <section className="p-3 flex justify-between border-b-2 border-gray-700 ">
            <div className="flex items-center text-sm leading-4">
        ...
        {isOpen && (
            <motion.ul 
                ...
                className="uppercase pb-6 absolute w-full bg-black">
                ...
                className="pb-3">contacto</motion.li>
            </motion.ul>
        )}
        </section>
    </nav>
